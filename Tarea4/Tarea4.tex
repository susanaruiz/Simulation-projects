...
Para el experimento de la figura 2 se sometió a una variación de la probabilidad inicial de propagación y se guardaron los datos para la zona más grande la de 150$\time%150 y observar el comportamiento de dichos datos. Se muestra que no ocurre mucha variación en la distancia a la que llegan las grietas, sí cambia el comportamiento en cuanto a estabilidad.
